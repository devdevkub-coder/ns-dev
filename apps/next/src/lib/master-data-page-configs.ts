...
export const accountsPageConfig: MasterDataPageConfig = {
  ...
  fields: [
    ...
    { key: 'accountCurrencyBalances', label: 'สกุลเงินและยอดตั้งต้น', type: 'currency-balances', optionsApiPath: '/api/master-data/currencies', optionValueKey: 'code', required: true, section: 'ยอดตั้งต้นบัญชี' },
    { key: 'currency', label: 'สกุลเงินตั้งต้นบัญชี', type: 'select', optionsApiPath: '/api/master-data/currencies', optionValueKey: 'code', required: true, section: 'ยอดตั้งต้นบัญชี' },
    { key: 'openingBalance', label: 'ยอดตั้งต้นบัญชี', type: 'number', inputFormat: 'money', section: 'ยอดตั้งต้นบัญชี' },
  ...
  columns: [
    ...
    { key: 'typeLabel', label: 'ประเภทบัญชีเงินบริษัท', width: 180, minWidth: 150 },
    { key: 'subtypeLabel', label: 'ประเภทบัญชีธนาคาร', width: 160, minWidth: 135 },
    ...
    { key: 'branchName', label: 'สาขาบริษัท', width: 150, minWidth: 120 },
