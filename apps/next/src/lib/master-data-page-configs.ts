...
export const accountsPageConfig: MasterDataPageConfig = {
  ...
  fields: [
    ...
    { key: 'currency', label: 'สกุลเงินหลัก', type: 'select', optionsApiPath: '/api/master-data/currencies', optionValueKey: 'code', required: true, section: 'ยอดตั้งต้นบัญชี' },
    { key: 'openingBalance', label: 'ยอดตั้งต้นบัญชี', type: 'number', inputFormat: 'money', section: 'ยอดตั้งต้นบัญชี' },
    { key: 'accountCurrencyBalances', label: 'สกุลเงินเพิ่มเติม', type: 'currency-balances', optionsApiPath: '/api/master-data/currencies', optionValueKey: 'code', required: true, section: 'ยอดตั้งต้นบัญชี' },
