const stockMovementTypeLabels: Record<string, string> = {
  ...
  PRODUCTION_INPUT_REVERSE_STOCK_IN: 'เข้า - ชดเชยคืนวัตถุดิบเข้าสต๊อก',
  PRODUCTION_INPUT_REVERSE_WIP_OUT: 'ออก - ชดเชยคืนวัตถุดิบจาก WIP',
  ...
  PRODUCTION_OUTPUT_REVERSE_STOCK_OUT: 'ออก - ชดเชยยกเลิกผลผลิตจากสต๊อก',
  PRODUCTION_OUTPUT_REVERSE_WIP_IN: 'เข้า - ชดเชยคืน WIP จากการยกเลิกผลผลิต',
