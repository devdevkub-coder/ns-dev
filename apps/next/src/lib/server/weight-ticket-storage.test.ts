...
beforeEach(() => {
  ...
  mocks.findSettings.mockResolvedValue([
    ...
    { key: 'WEIGHT_TICKET_DOWNLOAD_MAX_DIMENSION', value: '1600' },
    { key: 'WEIGHT_TICKET_DOWNLOAD_JPEG_QUALITY', value: '100' },
    ...
    { key: 'WEIGHT_TICKET_IMAGE_DOWNLOAD_ARTIFACT_RETENTION_SECONDS', value: '86400' },
