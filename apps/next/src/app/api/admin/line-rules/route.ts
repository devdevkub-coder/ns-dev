...
const lineDocumentTypeSchema = z.enum(['WTI', 'WTO', 'PB', 'SB', 'PMT', 'RCP', 'DAILY', 'MONTHLY'])
const lineRuleConditionsSchema = z.object({
  documentTypes: z.array(lineDocumentTypeSchema).min(1, 'เลือกเอกสารอย่างน้อย 1 ประเภท').max(8),
