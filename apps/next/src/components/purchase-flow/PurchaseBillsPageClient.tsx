    ...
    <section className="space-y-5">
      <Tabs className="gap-0" value={tab} onValueChange={(value) => switchTab(value as PurchaseBillsTab)}>
        <TabsList className="w-full" variant="line">
          <TabsTrigger className="flex-1 sm:flex-none" value="bills" variant="line">บิลรับซื้อ</TabsTrigger>
          <TabsTrigger className="flex-1 sm:flex-none" value="supplier-swap-history" variant="line">ประวัติเปลี่ยนบิลผู้ขาย</TabsTrigger>
        </TabsList>
      </Tabs>
