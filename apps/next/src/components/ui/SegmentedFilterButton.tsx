...
export function SegmentedFilterButton({ active, children, className, ...props }: SegmentedFilterButtonProps) {
  return (
    <button
      ...
      className={cn(
        'inline-flex h-9 items-center justify-center rounded-md border px-3 text-xs font-medium transition-colors focus-visible:outline-none focus-visible:border-blue-500 focus-visible:ring-[3px] focus-visible:ring-blue-500/30',
        active
