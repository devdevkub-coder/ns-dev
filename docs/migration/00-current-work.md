...
- Current next batch: redesign Audit Log / Activity Log including DB structure, API, and admin UI. Treat this as a fresh system-design batch rather than patching the old audit page in place.
