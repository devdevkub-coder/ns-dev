...
การ์ด `เงินพร้อมใช้วันนี้` หมายถึงเงินสด/ธนาคาร/FCD carrying THB ที่มีอยู่จริงเท่านั้น ไม่รวม AR, AP หรือวงเงิน OD ที่ยังไม่ได้ใช้ และการ์ด `เงินทุนหมุนเวียนสุทธิ` ใช้สูตร `เงินพร้อมใช้วันนี้ + AR - AP` ตามนิยามที่อนุมัติสำหรับหน้านี้ แม้ยังไม่รวมสต็อกหรือสินทรัพย์หมุนเวียนอื่น.
...
- แสดง `เงินพร้อมใช้วันนี้` แยกจาก `เงินทุนหมุนเวียนสุทธิ` เพื่อไม่ให้ AR ถูกเข้าใจว่าเป็นเงินสดพร้อมจ่าย.
