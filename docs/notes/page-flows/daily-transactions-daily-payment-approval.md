...
- ใบพิมพ์ชุดที่เลือกต้องแสดงรายการเดิมครบ, sort ให้ผู้รับเงิน/ผู้ขายและช่องทางจ่ายเดียวกันอยู่ติดกัน, แสดงทั้งเลขที่เอกสาร PMA และเอกสารอ้างอิงต้นทาง, ใช้วันที่ PMA ในคอลัมน์วันที่ และเพิ่มแถวรวมเมื่อผู้รับเงิน/ผู้ขายเดียวกันใช้ช่องทางจ่ายหรือเลขบัญชีเดียวกันมากกว่า 1 รายการ
- ใบพิมพ์ PMA ใช้ Company Profile เป็นหัวกระดาษและแบ่งหน้าตามตารางสูงสุด 15 แถวต่อหน้าโดยไม่จำกัดจำนวนหน้า; แถวรวมกลุ่มนับเป็นแถวตารางเพื่อไม่ให้เอกสารล้น A4
...
- print preview ใช้พื้นหลัง `#334155` และกระดาษ A4 landscape สีขาว; ตอนพิมพ์จริงต้องตัดพื้นหลัง preview, เงา, radius และระยะห่างระหว่างหน้าออก
- หน้า `1..N-1` มี footer ตารางว่าง, กรอบสรุปว่าง 2 กรอบ และข้อความมีต่อหน้าแทนลายเซ็น; หน้าสุดท้ายเท่านั้นที่แสดงยอดอนุมัติรวม จำนวนเงินตัวอักษร และช่องลงนาม
- การพิมพ์อ่านเฉพาะ PMA snapshot ที่ approved และไม่สร้าง/แก้ PMA, PMT, Bank Statement หรือสถานะเอกสาร
