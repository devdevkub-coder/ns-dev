...
- UI follow-up 2026-08-07: ปุ่ม `+ เพิ่มสินค้า` ใช้สีเขียวและอยู่เฉพาะหัวข้อรายการสินค้า เพื่อให้ผู้ใช้เพิ่มรายการจาก list แล้วจึงเข้าไปกรอกข้อมูลใน editor บนมือถือ/แท็บเล็ต; ไม่แสดงปุ่มเพิ่มสินค้าซ้ำในหัวแผง editor. ปุ่ม `+ เพิ่มเต๋า` อยู่ในหัวข้อเต๋าสินค้า, ปุ่ม `+ เพิ่มสิ่งเจือปน` อยู่ในหัวข้อสิ่งเจือปนหรือใน empty state เมื่อยังไม่มีรายการหัก และปุ่ม `บันทึก section นี้` อยู่ใน action bar มือถือแทนปุ่มเพิ่มเต๋า; desktop ยังคงแสดงปุ่มบันทึกใน section. แต่ละเต๋าแสดงเป็น section กรอบแยกพร้อมหัวข้อ `รายละเอียดเต๋าที่ ...` และยังยุบ/ขยายได้
