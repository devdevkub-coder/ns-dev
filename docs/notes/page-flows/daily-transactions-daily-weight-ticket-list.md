...
- PDF/ใบพิมพ์ WTI/WTO ต้องจัดความสูงจากแถวข้อมูลจริงโดยไม่เติมแถวว่างให้ครบโควตา เพื่อให้ตาราง สรุป และลายเซ็นอยู่ใน A4 หน้าหลักเดียวกันเมื่อเนื้อหาพอดี; ตัดเส้นประและข้อความท้ายเอกสาร `ขอบคุณที่ใช้บริการค่ะ/ครับ` ที่ไม่มีข้อมูลธุรกิจและอาจสร้างหน้าว่าง ส่วนหน้ารูปถ่ายแนบยังเริ่มหน้าใหม่ตามเดิม
