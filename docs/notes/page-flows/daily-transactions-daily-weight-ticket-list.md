...
- UI follow-up 2026-08-07: ปุ่ม `+ เพิ่มสินค้า` ใช้สีเขียวและอยู่เฉพาะหัวข้อรายการสินค้า เพื่อให้ผู้ใช้เพิ่มรายการจาก list แล้วจึงเข้าไปกรอกข้อมูลใน editor บนมือถือ/แท็บเล็ต; ไม่แสดงปุ่มเพิ่มสินค้าซ้ำในหัวแผง editor. ปุ่ม `+ เพิ่มเต๋า` ใช้สำหรับเพิ่มเต๋าภายในสินค้าที่กำลังแก้ไข ส่วน `+ เพิ่มสิ่งเจือปน` ใช้สีแดงเพื่อแยก action เพิ่มรายการหักออกจาก action เพิ่มสินค้า; แต่ละเต๋าแสดงเป็น section กรอบแยกพร้อมหัวข้อ `รายละเอียดเต๋าที่ ...` และยังยุบ/ขยายได้
