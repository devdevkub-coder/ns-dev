...
เมื่อผู้ใช้กด `เพิ่มสินค้า` หรือ `เพิ่มเต๋า` ระบบจะพยายามบันทึกใบเดิมเป็น `draft`
ก่อนเพิ่มแถวใหม่ เพื่อไม่ให้ข้อมูลที่กรอกครบแล้วสูญหายจากการทำงานต่อเนื่อง. การบันทึกนี้
ใช้เฉพาะข้อมูลที่ผ่าน validation ปัจจุบัน; แถวใหม่ที่ยังว่างจะยังอยู่ใน client state
จนกว่าจะกรอกครบแล้วกดบันทึก. การบันทึก draft ไม่ยืนยันเอกสารและไม่สร้างการจอง
`pending_out`; การยืนยัน WTO ยังคงเป็นจุดที่ตรวจ stock และสร้าง reservation ตาม flow เดิม.
