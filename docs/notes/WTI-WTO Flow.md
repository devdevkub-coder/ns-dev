...
- การเพิ่มรูปรถ/รูปสินค้า/รูปสิ่งเจือปนต้องตรวจว่าเป็นรูปที่รองรับและไม่เกิน 10 MB ก่อนส่ง; browser ไม่ resize หรือบีบอัดด้วย Canvas เพราะต้องไม่ทำให้เครื่องมือถือหน่วงหรือทำให้ต้นฉบับถูกย่อก่อนบันทึก. ฟอร์มหนึ่งชุดส่งได้พร้อมกันสูงสุด 6 รูป และไม่มี lock ข้ามแท็บหรือข้ามอุปกรณ์. Server เป็นผู้สร้าง thumbnail หลังรับไฟล์และทำการอัปโหลดต้นฉบับควบคู่กับการสร้าง thumbnail เพื่อลดเวลารอ ก่อนคืน preview URL ตาม storage contract. ก่อน decode รูป Server ตรวจ decoded pixel limit เพื่อป้องกันไฟล์บีบอัดที่ใช้หน่วยความจำสูงผิดปกติ
