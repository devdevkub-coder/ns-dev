...
- หลัง upload เดียวกัน job จะสร้าง download derivative เพิ่มสำหรับการดาวน์โหลดรูป: JPEG ด้านยาวสูงสุด `1600px`, quality `92`, รักษา ratio และไม่ขยายรูปเล็ก. การปรับ quality ใช้ migration และ backfill แบบ force กับ derivative เดิม โดยแตะเฉพาะไฟล์ดาวน์โหลด ไม่แตะ original. Download API จะ drain งานของ ticket ต่อเนื่องหลาย batch ก่อนสร้าง ZIP; ถ้า ZIP ถูกแบ่งหลายส่วน UI จะแสดงรายการให้เลือกดาวน์โหลดทีละไฟล์. Original ยังคงเป็นหลักฐานต้นฉบับและไม่ถูกเขียนทับ; PDF/LINE ใช้ print derivative 400px ต่อไป.
