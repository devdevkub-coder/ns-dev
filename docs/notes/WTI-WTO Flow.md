...
| 5 | กดบันทึก | ออกเลข `WTO...`, stamp วันเวลา/ผู้บันทึก, เขียน header/line/summary, intended warehouse ต่อ line, และ active pending_out โดยไม่เขียน stock ledger | `แบบร่าง` / `รอออก` |
| 6 | กด `ยืนยันส่งของ` | snapshot ต้นทุนของ pending_out และบันทึก timeline การยืนยัน | `ส่งของแล้ว` |
