...
เมื่อมีผู้ใช้หลายคนเปิดใบ WTI/WTO เดียวกัน realtime จะดึงข้อมูลล่าสุดมา merge โดยคง
