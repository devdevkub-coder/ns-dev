...
| ลบสินค้า, เต๋า หรือสิ่งเจือปนใน WTI/WTO | ถามยืนยันก่อนลบ แล้ว PATCH เฉพาะ line ที่ลบ/ความสัมพันธ์ที่เปลี่ยนทันที; ถ้าเป็นเอกสารใหม่ที่ยังไม่มี ID ให้คงการลบไว้ในฟอร์มจนกว่าจะสร้าง header draft | ให้ผู้ใช้หลายคนเห็นการลบเร็วขึ้น โดยไม่ส่งข้อมูลทั้งเอกสารและไม่ลบรายการของผู้ใช้อื่น |
...
- WTI/WTO ต้องส่งการลบสินค้า, เต๋า, สิ่งเจือปน และรูปภาพผ่าน `PATCH /api/daily/weight-tickets/:id` หลัง confirmation โดยส่ง `deletedLineIds`/line ที่เปลี่ยนเฉพาะส่วน; ห้ามใช้การลบแบบรอปุ่มบันทึกเอกสารเป็นทางเดียว.
