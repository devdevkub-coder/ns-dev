...
| `/pending-sales` | รายการรอขาย | [[Sales Flow]], [[Cost Pool]] | accepted code baseline | planning summary: compare stock/cost pool/PO Sell commitments and sale readiness | define pending_out from WTO and cost pool quantities clearly in the UI |
