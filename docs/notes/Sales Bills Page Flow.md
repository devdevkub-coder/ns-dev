...
- A4 portrait
- แบ่งหน้าละ 15 รายการและสร้างหน้า `1..N` อัตโนมัติโดยไม่จำกัดไว้ที่ 2 หน้า; หน้า `1..N-1` แสดงยอด/หมายเหตุเป็น `-` และไม่มีลายเซ็น ส่วนหน้า `N` แสดงยอดจริง/หมายเหตุ/ลายเซ็น
