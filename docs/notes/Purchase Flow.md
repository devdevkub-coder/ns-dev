...
| 14 | ยกเลิกบิลรับซื้อ (ถ้ายังไม่มีการจ่าย) | กรอกเหตุผลการยกเลิก | ไม่มี | PB = `ยกเลิก` | ลบผลกระทบ stock ledger ของบิล และ recalc การใช้งาน WTI ใหม่จากบิลที่ยัง active อยู่ |
