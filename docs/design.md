...
- **Multi-Page Corporate Print Layout Standard (มาตรฐานการจัดหน้าเอกสารพิมพ์หลายหน้า):**
  - **เอกสาร 1 หน้าปกติ (<= 15 รายการ):** ใช้ Auto Dense Sizing (`.is-dense` สำหรับ 9–15 รายการ) พิมพ์จบใน 1 หน้า A4 มีสรุปยอดเงินสุทธิและช่องเซ็นชื่ออนุมัติเต็มรูปแบบในหน้าเดียว
  - **เอกสารหลายหน้า (> 15 รายการ):**
    - **หน้า 1 ถึง หน้าก่อนสุดท้าย (Page 1..N-1):** แสดง Header (ระบุเลขหน้า เช่น `หน้า 1/2`) + ข้อมูลคู่ค้า/ผู้รับ/ผู้จ่ายเงิน + ตารางสินค้า 15 รายการพอดี + **คงพื้นที่ footer ตารางและกรอบสรุปตามโครงสร้างเดิมแต่ปล่อยว่างจริง ห้ามใส่ `-`, label หรือยอดระหว่างทาง** + วางข้อความ **`( มีต่อหน้า X / Continued on Page X ➔ )` ไว้ตรงกลางเด่นชัดแทนช่องเซ็นชื่อ** + หมายเหตุทางกฎหมาย
    - **หน้าสุดท้าย (Final Page):** แสดง Header (ระบุ `หน้า N/N`) + ข้อมูลคู่ค้า/ผู้รับ/ผู้จ่ายเงิน + ตารางสินค้าส่วนที่เหลือ (เติมแถวว่างให้ได้ 15 แถวเท่ากัน) + **ตารางสรุปเงินสดสุทธิ (ลงตัวเลขจริงคำนวณสรุปและตัวอักษรบาทถ้วน)** + **ช่องลงลายมือชื่ออนุมัติเต็มรูปแบบ (`ผู้จ่ายเงิน` / `ผู้รับเงิน`)** + หมายเหตุทางกฎหมาย
