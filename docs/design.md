...
- **Multi-Page Corporate Print Layout Standard (มาตรฐานการจัดหน้าเอกสารพิมพ์หลายหน้า):**
  ...
  - **เอกสารหลายหน้า (> 15 รายการ):**
    - **หน้า 1 ถึง หน้าก่อนสุดท้าย (Page 1..N-1):** แสดง Header (ระบุเลขหน้า เช่น `หน้า 1/2`) + ข้อมูลคู่ค้า/ผู้รับ/ผู้จ่ายเงิน + ตารางสินค้า 15 รายการพอดี + **คงกรอบสรุปเงินสดไว้แต่แสดงเครื่องหมาย `-` (เว้นว่างไว้ ไม่ลงตัวเลขสรุปเพื่อป้องกันสับสน)** + วางข้อความ **`( มีต่อหน้า X / Continued on Page X ➔ )` ไว้ตรงกลางเด่นชัดแทนช่องเซ็นชื่อ** + หมายเหตุทางกฎหมาย
