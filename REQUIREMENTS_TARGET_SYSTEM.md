...
- ระบบต้องมีเอกสารพิมพ์/Save as PDF สำหรับเอกสารธุรกิจหลักตาม `docs/notes/Printable Documents.md`: `PB`, `SB`, `WTI/WTO`, `PMA`, `PMT`, `RV`, และ `RCP`; ทุกเอกสารต้องใช้ Company Profile เป็นหัวกระดาษและต้องไม่ก่อ side effect ตอนพิมพ์
